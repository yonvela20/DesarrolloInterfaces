    ...
    <div class="menu-transoil">
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-transoil">
            <a class="navbar-brand" href="index.php">Transoil</a>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown dropdownTransoil">
                        ...
                        <div class="dropdown-menu dropdown-content" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="recogida_aceite.php"> Recogida de aceite </a>
                            <a class="dropdown-item" href="tienda.php"> Venta de productos </a>
                            <a class="dropdown-item" href="tienda.php"> Recambios </a>
                        </div>
                    </li>
                    <li class="nav-item">
